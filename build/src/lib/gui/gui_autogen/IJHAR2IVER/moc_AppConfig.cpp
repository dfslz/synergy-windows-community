...
#include "../../../../../../src/lib/gui/config/AppConfig.h"
...
constexpr auto qt_meta_stringdata_CLASSAppConfigENDCLASS = QtMocHelpers::stringData(
    "AppConfig",
    "tlsChanged",
    "",
    "screenNameChanged",
    "invertConnectionChanged"
);
...
Q_CONSTINIT const QMetaObject AppConfig::staticMetaObject = { {
    ...
    qt_static_metacall,
    nullptr,
    qt_incomplete_metaTypeArray<qt_meta_stringdata_CLASSAppConfigENDCLASS_t,
        // Q_OBJECT / Q_GADGET
        QtPrivate::TypeAndForceComplete<AppConfig, std::true_type>,
        // method 'tlsChanged'
        QtPrivate::TypeAndForceComplete<void, std::false_type>,
        // method 'screenNameChanged'
        QtPrivate::TypeAndForceComplete<void, std::false_type>,
        // method 'invertConnectionChanged'
        QtPrivate::TypeAndForceComplete<void, std::false_type>
    >,
    nullptr
} };
...
void AppConfig::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        (void)_t;
        switch (_id) {
        case 0: _t->tlsChanged(); break;
        case 1: _t->screenNameChanged(); break;
        case 2: _t->invertConnectionChanged(); break;
        default: ;
        }
        ...
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            ...
            if (_t _q_method = &AppConfig::tlsChanged; *reinterpret_cast<_t *>(_a[1]) == _q_method) {
                *result = 0;
                return;
            }
        }
        {
            using _t = void (AppConfig::*)();
            if (_t _q_method = &AppConfig::screenNameChanged; *reinterpret_cast<_t *>(_a[1]) == _q_method) {
                *result = 1;
                return;
            }
        }
        {
            using _t = void (AppConfig::*)();
            if (_t _q_method = &AppConfig::invertConnectionChanged; *reinterpret_cast<_t *>(_a[1]) == _q_method) {
                *result = 2;
                return;
            }
        }
...
void *AppConfig::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, "synergy::gui::IAppConfig"))
        return static_cast< synergy::gui::IAppConfig*>(this);
...
// SIGNAL 0
void AppConfig::tlsChanged()
{
    QMetaObject::activate(this, &staticMetaObject, 0, nullptr);
}

// SIGNAL 1
void AppConfig::screenNameChanged()
{
    QMetaObject::activate(this, &staticMetaObject, 1, nullptr);
}

// SIGNAL 2
void AppConfig::invertConnectionChanged()
{
